  ...
  <section id="topbar" class="topbar d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">sirinehentati2084@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+216 53995317</span></i>
      </div>
...
<div style="display:grid; grid-template-columns: 60% 70%;">
    ...
    <section id="stats-counter" class="stats-counter">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6">
            <img src="assets/img/statics.jpg" alt="" class="img-fluid">
          </div>
